        ...
        <div class="col-md-6">
          <form action="" @submit.prevent="fetch">
            <div class="input-group mb-3">
              ...
              <input type="text" class="form-control" v-model="stockID" placeholder="Stock ID" autofocus>
            ...
            <div id="stockTimeGroup" class="my-2">
              ...
              <div class="form-check form-check-inline">
                ...
                <label class="form-check-label" for="stockTimeDatePick">選擇日期</label>
              </div>
            </div>
          </form>
        </div>
...
export default {
  ...
  methods: {
    fetch() {
      const api = `https://mis.twse.com.tw/stock/api/getStockInfo.jsp?ex_ch=${this.stockType}_${this.stockID}.tw&json=1&delay=0`
      this.isLoading = true;
